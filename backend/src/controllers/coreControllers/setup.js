...
const setup = async (req, res) => {
  ...
  for (const filePath of settingsFiles) {
    ...
    const settingsToUpdate = {
      evenmore_app_email: email,
      evenmore_app_company_email: email,
      evenmore_app_timezone: timezone,
      evenmore_app_country: country,
      evenmore_app_language: language || 'en_us',
    };
  ...
  return res.status(200).json({
    success: true,
    result: {},
    message: 'Successfully Evenmore App Setup',
  });
};
